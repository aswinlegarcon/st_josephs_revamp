<?php // "Groups Offered" cards (highsec) — clean fragment (no nested document).
// The <style> is VERBATIM from _templates/groups.php — do not tidy (incl. the
// .groups body-class rule, which matched nothing on the baseline because the
// nested <body class="groups"> was discarded by the parser; no wrapper is
// added here so it keeps matching nothing). ?>
  <style>
    .groups{
