...
.gal-children-container {
  position: relative;
  min-height: 90vh;
  background: #ddd;
}
.gal-children-container h1 {
...
.gal-children-container .image-container {
  display: flex;
  flex-wrap: wrap;
  gap: 15px;
...
.gal-children-container .image-container .image {
  height: 250px;
  width: 350px;
...
.gal-children-container .image-container .image img {
  height: 100%;
  width: 100%;
  object-fit: cover;
  transition: 0.2s linear;
}
.gal-children-container .image-container .image:hover img {
  transform: scale(1.1);
}

.gal-children-container .popup-image {
  position: fixed;
  top: 0;
  left: 0;
...
.gal-children-container .popup-image span {
  position: absolute;
  top: 0;
  right: 10px;
  font-size: 60px;
...
.gal-children-container .popup-image span:hover {
  color: #ffd700;
}
.gal-children-container .btn-group {
  margin-left: 20px;
}
.gal-children-container .btn {
  background-color: #2b4b8a !important;
  border: 2px solid #fff !important;
  color: #fff !important;
  text-decoration: none;
}
.gal-children-container .btn:hover {
  background-color: #ffd700 !important;
  color: #333 !important;
}
.gal-children-container .popup-image img {
  position: absolute;
  top: 50%;
  left: 50%;
...
.gal-children-container .navigation-buttons {
  position: absolute;
  top: 50%;
  padding: 20px;
  width: 100%;
...
.gal-children-container .navigation-buttons button {
...
.gal-children-container .navigation-buttons button:hover {
  color: #ffd700;
}
...
<div class="gal-children-container">
    ...
    <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
        ...
        <label class="btn btn-outline-primary" for="btnradio2023">2024</label>
    ...
    <div class="image-container">
        <!-- 2023 images -->
        <div class="image year-2023"><img id="image-0" src="/photos/child1.jpg" alt=""></div>  
        <div class="image year-2023"><img id="image-1" src="/photos/child2.jpg" alt=""></div>
        <div class="image year-2023"><img id="image-2" src="/photos/childday3.jpg" alt=""></div>
        <div class="image year-2023"><img id="image-3" src="/photos/childday4.jpg" alt=""></div>
        <div class="image year-2023"><img id="image-3" src="/photos/childday5.jpg" alt=""></div>
        <div class="image year-2023"><img id="image-2" src="/photos/childday6.jpeg" alt=""></div>
        <div class="image year-2023"><img id="image-3" src="/photos/childday7.jpeg" alt=""></div>
        <div class="image year-2023"><img id="image-3" src="/photos/childday8.jpeg" alt=""></div>
        <div class="image year-2023"><img id="image-3" src="/photos/childday9.jpeg" alt=""></div>
        <div class="image year-2023"><img id="image-3" src="/photos/childday10.jpeg" alt=""></div>
        <div class="image year-2023"><img id="image-3" src="/photos/childday11.jpeg" alt=""></div>
        <div class="image year-2023"><img id="image-3" src="/photos/childday12.jpeg" alt=""></div>
        <div class="image year-2023"><img id="image-3" src="/photos/childday13.jpeg" alt=""></div>
    ...
    <div class="popup-image">
        <span>&times;</span>
        <img src="/photos/childday1.jpg" alt="">
...
<script>
const images = document.querySelectorAll('.gal-children-container .image-container img');
