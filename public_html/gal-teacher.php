...
.gal-teacher-container {
  position: relative;
  min-height: 90vh;
  background: #ddd;
}
.gal-teacher-container h1 {
...
.gal-teacher-container .image-container {
  display: flex;
  flex-wrap: wrap;
  gap: 15px;
...
.gal-teacher-container .image-container .image {
  height: 250px;
  width: 350px;
...
.gal-teacher-container .image-container .image img {
  height: 100%;
  width: 100%;
  object-fit: cover;
  transition: 0.2s linear;
}
.gal-teacher-container .image-container .image:hover img {
  transform: scale(1.1);
}

.gal-teacher-container .popup-image {
  position: fixed;
  top: 0;
  left: 0;
...
.gal-teacher-container .popup-image span {
  position: absolute;
  top: 0;
  right: 10px;
  font-size: 60px;
...
.gal-teacher-container .popup-image span:hover {
  color: #ffd700;
}
.gal-teacher-container .btn-group {
  margin-left: 20px;
}
.gal-teacher-container .btn {
  background-color: #2b4b8a !important;
  border: 2px solid #fff !important;
  color: #fff !important;
  text-decoration: none;
}
.gal-teacher-container .btn:hover {
  background-color: #ffd700 !important;
  color: #333 !important;
}
.gal-teacher-container .popup-image img {
  position: absolute;
  top: 50%;
  left: 50%;
...
.gal-teacher-container .navigation-buttons {
  position: absolute;
  top: 50%;
  padding: 20px;
  width: 100%;
...
.gal-teacher-container .navigation-buttons button {
...
.gal-teacher-container .navigation-buttons button:hover {
  color: #ffd700;
}
...
<div class="gal-teacher-container">
    ...
    <div class="image-container">
        <!-- 2023 images -->
        <div class="image year-2023"><img id="image-0" src="/photos/teachday1.jpg" alt=""></div>  
        <div class="image year-2023"><img id="image-1" src="/photos/teachday2.jpg" alt=""></div>
        <div class="image year-2023"><img id="image-2" src="/photos/teachday3.jpg" alt=""></div>
        <div class="image year-2023"><img id="image-3" src="/photos/teachday4.jpg" alt=""></div>
        <div class="image year-2023"><img id="image-3" src="/photos/teachday5.jpg" alt=""></div>
        <div class="image year-2023"><img id="image-2" src="/photos/teachday6.jpg" alt=""></div>
        <div class="image year-2023"><img id="image-3" src="/photos/teachday7.jpg" alt=""></div>
        <div class="image year-2023"><img id="image-3" src="/photos/teachday8.jpg" alt=""></div>
        <div class="image year-2023"><img id="image-3" src="/photos/teachday9.jpg" alt=""></div>
        <div class="image year-2023"><img id="image-3" src="/photos/teachday10.jpg" alt=""></div>
    ...
    <div class="popup-image">
        <span>&times;</span>
        <img src="/photos/teachday1.jpg" alt="">
...
<script>
const images = document.querySelectorAll('.gal-teacher-container .image-container img');
