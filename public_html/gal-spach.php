...
.gal-spach-container .image-container {
  display: flex;
  flex-wrap: wrap;
  gap: 15px;
...
.gal-spach-container .image-container .image {
  height: 250px;
  width: 350px;
...
.gal-spach-container .image-container .image img {
  height: 100%;
  width: 100%;
  object-fit: cover;
  transition: 0.2s linear;
}
.gal-spach-container .image-container .image:hover img {
  transform: scale(1.1);
}

.gal-spach-container .popup-image {
  position: fixed;
  top: 0;
  left: 0;
...
.gal-spach-container .popup-image span {
  position: absolute;
  top: 0;
  right: 10px;
  font-size: 60px;
...
.gal-spach-container .popup-image span:hover {
  color: #ffd700;
}
.gal-spach-container .btn-group {
  margin-left: 20px;
}
.gal-spach-container .btn {
  background-color: #2b4b8a !important;
  border: 2px solid #fff !important;
  color: #fff !important;
  text-decoration: none;
}
.gal-spach-container .btn:hover {
  background-color: #ffd700 !important;
  color: #333 !important;
}
.gal-spach-container .popup-image img {
  position: absolute;
  top: 50%;
  left: 50%;
...
.gal-spach-container .navigation-buttons {
  position: absolute;
  top: 50%;
  padding: 20px;
  width: 100%;
...
.gal-spach-container .navigation-buttons button {
...
.gal-spach-container .navigation-buttons button:hover {
  color: #ffd700;
}
...
<div class="gal-spach-container">
    ...
    <div class="image-container">
        <!-- 2023 images -->
        <div class="image year-2023"><img id="image-0" src="/photos/spach1.jpg" alt=""></div>  
        <div class="image year-2023"><img id="image-1" src="/photos/spach2.jpg" alt=""></div>
        <div class="image year-2023"><img id="image-2" src="/photos/spach3.jpg" alt=""></div>
        <div class="image year-2023"><img id="image-3" src="/photos/spach4.jpg" alt=""></div>
        <div class="image year-2023"><img id="image-3" src="/photos/spach5.jpg" alt=""></div>
        <div class="image year-2023"><img id="image-2" src="/photos/spach6.jpg" alt=""></div>
        <div class="image year-2023"><img id="image-3" src="/photos/spach7.jpg" alt=""></div>
        <div class="image year-2023"><img id="image-3" src="/photos/spach8.jpg" alt=""></div>
        <div class="image year-2023"><img id="image-3" src="/photos/spach9.jpg" alt=""></div>
        <div class="image year-2023"><img id="image-3" src="/photos/spach10.jpg" alt=""></div>
        <div class="image year-2023"><img id="image-3" src="/photos/spach11.jpg" alt=""></div>
        <div class="image year-2023"><img id="image-3" src="/photos/spach12.jpg" alt=""></div>
        <div class="image year-2023"><img id="image-3" src="/photos/spach13.jpg" alt=""></div>
        <div class="image year-2023"><img id="image-3" src="/photos/spach14.jpg" alt=""></div>
        <div class="image year-2023"><img id="image-3" src="/photos/spach15.jpg" alt=""></div>
        <div class="image year-2023"><img id="image-3" src="/photos/spach16.jpg" alt=""></div>
...
<script>
const images = document.querySelectorAll('.gal-spach-container .image-container img');
