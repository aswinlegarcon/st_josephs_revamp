...
/* content strt */
        .bg-1{
            background: linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)),url('../photos/abacaca1.jpg') no-repeat;;
...
<h4>Academy of Abacus</h4>
<p>Saibodhi Abacus Academy</p>
</div>
</section>
<!-- content -->
...
<section class="infra-new bg-1">
    ...
    <div id="carouselExampleIndicators" class="carousel slide carousel-fade" data-ride="carousel" data-interval="2000">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="/photos/abacaca2.jpg" alt="First slide">
        </div>
        <div class="carousel-item">
          <img class="d-block w-100" src="/photos/abacaca3.jpg" alt="Second slide">
        </div>
        <div class="carousel-item">
          <img class="d-block w-100" src="/photos/abacaca4.jpg" alt="Third slide">
        </div>
      </div>
  ...
  <div class="infra-new-text">
    <h4 class="infra-new-reveal">Academy of Abacus</h4>
      <p>
