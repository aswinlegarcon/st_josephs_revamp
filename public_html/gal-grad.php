...
.gal-grad-container .image-container {
  display: flex;
  flex-wrap: wrap;
  gap: 15px;
...
.gal-grad-container .image-container .image {
  height: 250px;
  width: 350px;
...
.gal-grad-container .image-container .image img {
  height: 100%;
  width: 100%;
  object-fit: cover;
  transition: 0.2s linear;
}
.gal-grad-container .image-container .image:hover img {
  transform: scale(1.1);
}

.gal-grad-container .popup-image {
  position: fixed;
  top: 0;
  left: 0;
...
.gal-grad-container .popup-image span {
  position: absolute;
  top: 0;
  right: 10px;
  font-size: 60px;
...
.gal-grad-container .popup-image span:hover {
  color: #ffd700;
}
.gal-grad-container .btn-group {
  margin-left: 20px;
}
.gal-grad-container .btn {
  background-color: #2b4b8a !important;
  border: 2px solid #fff !important;
  color: #fff !important;
  text-decoration: none;
}
.gal-grad-container .btn:hover {
  background-color: #ffd700 !important;
  color: #333 !important;
}
.gal-grad-container .popup-image img {
  position: absolute;
  top: 50%;
  left: 50%;
...
.gal-grad-container .navigation-buttons {
  position: absolute;
  top: 50%;
  padding: 20px;
  width: 100%;
...
.gal-grad-container .navigation-buttons button {
...
.gal-grad-container .navigation-buttons button:hover {
  color: #ffd700;
}
...
<div class="gal-grad-container">
    <h1>KG Graduation Day</h1>
    ...
    <div class="image-container">
        <!-- 2023 images -->
        <div class="image year-2023"><img id="image-0" src="/photos/gradday1.jpg" alt=""></div>  
        <div class="image year-2023"><img id="image-1" src="/photos/kggrad3.jpg" alt=""></div>
        <div class="image year-2023"><img id="image-2" src="/photos/gradday3.jpg" alt=""></div>
        <div class="image year-2023"><img id="image-3" src="/photos/gradday4.jpg" alt=""></div>
        <div class="image year-2023"><img id="image-3" src="/photos/gradday5.jpg" alt=""></div>
        <div class="image year-2023"><img id="image-2" src="/photos/gradday6.jpg" alt=""></div>
        <div class="image year-2023"><img id="image-3" src="/photos/gradday7.jpg" alt=""></div>
        <div class="image year-2023"><img id="image-3" src="/photos/gradday8.jpg" alt=""></div>
        <div class="image year-2023"><img id="image-3" src="/photos/kggrad4.jpg" alt=""></div>
        <div class="image year-2023"><img id="image-3" src="/photos/gradday10.jpg" alt=""></div>
        <div class="image year-2023"><img id="image-3" src="/photos/gradday11.jpg" alt=""></div>
        <div class="image year-2023"><img id="image-3" src="/photos/gradday12.jpg" alt=""></div>
        <div class="image year-2023"><img id="image-3" src="/photos/gradday13.jpg" alt=""></div>
        <div class="image year-2023"><img id="image-3" src="/photos/kggrad1.jpg" alt=""></div>
        <div class="image year-2023"><img id="image-3" src="/photos/kggrad2.jpg" alt=""></div>
    ...
    <div class="popup-image">
        <span>&times;</span>
        <img src="/photos/gradday1.jpg" alt="">
...
<script>
const images = document.querySelectorAll('.gal-grad-container .image-container img');
