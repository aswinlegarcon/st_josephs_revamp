...
.gal-alumni-container {
  position: relative;
  min-height: 90vh;
  background: #ddd;
}
.gal-alumni-container h1 {
...
.gal-alumni-container .image-container {
  display: flex;
  flex-wrap: wrap;
  gap: 15px;
...
.gal-alumni-container .image-container .image {
  height: 250px;
  width: 350px;
...
.gal-alumni-container .image-container .image img {
  height: 100%;
  width: 100%;
  object-fit: cover;
  transition: 0.2s linear;
}
.gal-alumni-container .image-container .image:hover img {
  transform: scale(1.1);
}

.gal-alumni-container .popup-image {
  position: fixed;
  top: 0;
  left: 0;
...
.gal-alumni-container .popup-image span {
  position: absolute;
  top: 0;
  right: 10px;
  font-size: 60px;
...
.gal-alumni-container .popup-image span:hover {
  color: #ffd700;
}
.gal-alumni-container .btn-group {
  margin-left: 20px;
}
.gal-alumni-container .btn {
  background-color: #2b4b8a !important;
  border: 2px solid #fff !important;
  color: #fff !important;
  text-decoration: none;
}
.gal-alumni-container .btn:hover {
  background-color: #ffd700 !important;
  color: #333 !important;
}
.gal-alumni-container .popup-image img {
  position: absolute;
  top: 50%;
  left: 50%;
...
.gal-alumni-container .navigation-buttons {
  position: absolute;
  top: 50%;
  padding: 20px;
  width: 100%;
...
.gal-alumni-container .navigation-buttons button {
...
.gal-alumni-container .navigation-buttons button:hover {
  color: #ffd700;
}
...
<div class="gal-alumni-container">
    ...
    <div class="image-container">
        <!-- 2023 images -->
        <div class="image year-2023"><img id="image-0" src="/photos/alumni1.png" alt=""></div>  
        <div class="image year-2023"><img id="image-1" src="/photos/alumni2.png" alt=""></div>
        <div class="image year-2023"><img id="image-2" src="/photos/alumni3.png" alt=""></div>
        <div class="image year-2023"><img id="image-3" src="/photos/alumni4.png" alt=""></div>
        <div class="image year-2023"><img id="image-3" src="/photos/alumni5.png" alt=""></div>
        <div class="image year-2023"><img id="image-2" src="/photos/alumni6.png" alt=""></div>
        <div class="image year-2023"><img id="image-3" src="/photos/alumni7.png" alt=""></div>
        <div class="image year-2023"><img id="image-3" src="/photos/alumni8.png" alt=""></div>
        <div class="image year-2023"><img id="image-3" src="/photos/alumni9.png" alt=""></div>
        <div class="image year-2023"><img id="image-3" src="/photos/alumni10.png" alt=""></div>
    ...
    <div class="popup-image">
        <span>&times;</span>
        <img src="/photos/alumni1.jpg" alt="">
...
<script>
const images = document.querySelectorAll('.gal-alumni-container .image-container img');
