...
**Status: 🔴** Any third party can lift the keys and drive the school's EmailJS quota (cost + inbox spam) or send mail from any origin. reCAPTCHA is bypassable if verification is client-side only.
